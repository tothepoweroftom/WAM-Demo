...
NOTARIZE_BUNDLE_ID=com.TomPower.WAMDemo
NOTARIZE_BUNDLE_ID_DEMO=com.TomPower.WAMDemo.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/WAMDemo.iss
#  git checkout installer/WAMDemo.pkgproj
