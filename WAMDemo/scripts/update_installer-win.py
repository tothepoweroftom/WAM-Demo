...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=WAMDemo Demo Installer\n"
      else:
        line="OutputBaseFilename=WAMDemo Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the WAMDemo Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the WAMDemo installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=WAMDemo Demo installer\n"
     else:
       line="SetupWindowTitle=WAMDemo installer\n"
